...
if agree:
    ...
    if st.button('Submit'):
        ...
        dir_of_interest1= os.path.join(dir_of_interest, "images") 
        im1 = img1.save(f"{dir_of_interest1}\custom.png")
        
        IMAGE_PATH = os.path.join(dir_of_interest, "images", "custom.png") 
